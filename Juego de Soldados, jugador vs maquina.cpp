...
public:
    ...
    bool checkrep(int ubicacionb, int repetir[])
{
    for(int i=0; i<10; i++)
        if(ubicacionb == repetir[i])
            return true;
    return false;
}// //_________________________________________________________________
        ...
        void jugadorB(){
            ...
            cout<<endl<<endl;
            cout<<"Jugador Maquina, usted tiene 3 Soldados"<<endl;
             srand(time(NULL));
                    for(int i=0;i<3;i++) {

                    do
                        ubicacionb=(rand() % 10+1);
                        while(checkrep(ubicacionb, repetir));
                        repetir[i] = ubicacionb;


                       cout<<"Las posiciones elegidas del soldado: "<<i+1<<": "<<" "<<ubicacionb<<endl;
                    soldadob=1;
...
void start_game(){
    ...
    cout<<endl<<endl;
        ...
        encontrado=0;
             cout<<endl<<endl;
            cout<<"Maquina, Realice el Disparo en la ubicación: " ;
            n=(rand() % 10+1);
            for ( i=0; i<10; i++ ){
...
void validar(){
    ...
    for(int i= 0; i<10;i++){
        ...
        cout<<"Jugador A, soldados con Vida: "<<sumaA<<endl;
         cout<<endl<<endl;
        cout<<"Maquina, soldados con Vida: "<<sumaB<<endl;
            if((sumaA>0)&&(sumaB>0)){
                start_game();
            }
            else{
            ...
            if (sumaA==0){
                cout<<"La Maquina, es el Ganador"<<endl;
            }else{
